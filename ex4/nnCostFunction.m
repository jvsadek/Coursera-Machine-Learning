...
Theta = [nn_params(hidden_layer_size+1:hidden_layer_size*(input_layer_size + 1)); ...
 nn_params(hidden_layer_size*(input_layer_size + 1)+num_labels+1:end)];
